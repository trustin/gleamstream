...
public enum GamepadComponent implements Serializable {
    BTN_A("Button 1 (A)", false), BTN_X("Button 2 (X)", false), BTN_Y("Button 3 (Y)", false), BTN_B(
            "Button 4 (B)", false),
    DPAD_UP("D-pad Up", false), DPAD_DOWN("D-pad Down", false), DPAD_LEFT("D-pad Left", false), DPAD_RIGHT(
            "D-pad Right", false),
    LS_RIGHT("Left Stick Right", true), LS_LEFT("Left Stick Left", true), LS_UP("Left Stick Up", true), LS_DOWN(
            "Left Stick Down", true),
    RS_RIGHT("Right Stick Right", true), RS_LEFT("Right Stick Left", true), RS_UP("Right Stick Up", true),
    RS_DOWN("Right Stick Down", true),
