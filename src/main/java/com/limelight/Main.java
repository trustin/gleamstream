...
public class Main implements NvConnectionListener {
    ...
    private static void createFrame() {
        ...
        if (!PreferencesManager.hasExistingPreferences() &&
            ...
            displayUiMessage(null, "Gamepad mapping is not set. If you want to use a gamepad, " +
                                   ...
                                   +
                                   " it will work while streaming.", "Moonlight",
    ...
    private static void parseCommandLine(String[] args) {
        ...
        if (host == null) {
            System.out.println(
                    "Syntax Error: You must include a host. Use -host to specifiy a hostname or ip address.");
            System.exit(5);
        }
    ...
    public void connectionTerminated(Exception e) {
        ...
        if (!connectionTerminating) {
            ...
            // shortly
            new Thread(() -> displayError("Connection Terminated", "The connection failed unexpectedly"))
                    .start();
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (httpConn.getPairState(serverInfo) == PairingManager.PairState.PAIRED) {
                    ...
                    new Thread(() -> displayUiMessage(null, "Please enter the following PIN on the target PC: "
                                                            + pinStr,
